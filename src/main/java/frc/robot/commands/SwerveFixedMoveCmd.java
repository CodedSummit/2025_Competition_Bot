...
public class SwerveFixedMoveCmd extends Command {
    ...
    public SwerveFixedMoveCmd(SwerveSubsystem swerveSubsystem, double joystick_x, double joystick_y, double run_seconds) {
